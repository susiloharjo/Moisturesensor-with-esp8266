...
//  pinMode(bluePin, OUTPUT);
  ...
  WiFi.config(IPAddress(10,80,3,124), IPAddress(10, 80, 3, 1), IPAddress(255, 255, 255, 0));
...
void loop() {
  ...
  int chartValue = (analogValue * 100) / 800;
